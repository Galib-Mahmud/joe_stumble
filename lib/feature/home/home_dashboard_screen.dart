...
class _HomeDashboardScreenState extends State<HomeDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        Padding(
          ...
          child: GridView.count(
            shrinkWrap: true, // ✅ Prevents full screen scroll conflict
      ...
      // bottomNavigationBar: CustomBottomNavigationBar(currentIndex: null,, onTabSelected: (int p1) {  },), // Custom navigation bar
    );
  }
