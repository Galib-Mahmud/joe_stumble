...
class DayOneBadgeScreen extends StatelessWidget {
  @override
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // Subtitle text
                Text(
                  'Post your wins stories and struggle to feed',
                  style: TextStyle(
                    fontSize: 14.sp,
                ...
                CustomButton(text: "Next", onPressed: () {
                 ...
                 Get.toNamed(RouteName.courageBadge);
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: unlocked
              ? Image.asset(
            'assets/images/community/congratulation.png', // Replace with your image path
            width: 60.sp, // Set the width of the image
            height: 60.sp, // Set the height of the image
